...
public class DataInitializer implements CommandLineRunner {
    ...
    private void createPost(){
        if(postDao.count() == 0){
            ...
            post1.setImage(imageFile + "spring-boot-api.jpg");
            ...
            post2.setImage(imageFile + "nepal-travel.jpg");
            ...
            post3.setImage(imageFile + "momo-recipe.jpg");
            ...
            post4.setImage(imageFile + "mongodb-relationships.jpg");
            ...
            post5.setImage(imageFile + "annapurna-trek.jpg");
